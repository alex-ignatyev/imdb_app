...
@Composable
fun ActorList(
    @PreviewParameter(ActorProvider::class, 1) actors: List<ActorModel>,
...
class ActorProvider : PreviewParameterProvider<List<ActorModel>> {
    override val values = sequenceOf(listOf(ActorModel(), ActorModel(), ActorModel()))
}
